...
BLOB_DATA_SOURCE_NAME = os.getenv("AZURE_BLOB_DATA_SOURCE_NAME_BET")

# Azure AI Search settings
SEARCH_ENDPOINT = os.getenv("AZURE_AI_SEARCH_ENDPOINT")
SEARCH_API_KEY = os.getenv("AZURE_AI_SEARCH_API_KEY")
SEARCH_INDEX_NAME = os.getenv("AZURE_AI_SEARCH_INDEX_BET")
SEARCH_INDEX_PATH = os.getenv("AZURE_AI_SEARCH_INDEX_CONFIG_PATH_BET")
SEARCH_INDEXER_NAME =  os.getenv("AZURE_AI_SEARCH_INDEXER_BET")
SEARCH_INDEXER_PATH = os.getenv("AZURE_AI_SEARCH_INDEXER_CONFIG_PATH_BET")
SEARCH_SKILLSET_NAME =  os.getenv("AZURE_AI_SEARCH_SKILLSET_BET")
SEARCH_SKILLSET_PATH = os.getenv("AZURE_AI_SEARCH_SKILLSET_CONFIG_PATH_BET")

# Initialize Azure Search Client
def _delete_all_documents_from_index():
    ...
    if ids:
        ...
        print(f"Deleted {len(ids)} documents from index '{SEARCH_INDEX_NAME}'\n.")
    else:
        print(f"No documents found to delete from index '{SEARCH_INDEX_NAME}'\n.")
...
# Function to deploy azure search JSON configuration file via API call
...
def _create_or_update_search_index(index_name, filepath,  api_endpoint, api_key):
    _delete_all_documents_from_index()
